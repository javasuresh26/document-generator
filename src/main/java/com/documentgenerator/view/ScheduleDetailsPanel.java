 ...
 */
//@Component
public class ScheduleDetailsPanel extends JPanel {
    ...
    public ScheduleDetailsPanel(JFrame frame) {
        this.frame = frame;
    ...
    private void loadTable() {
        ...
        try {
            ...
            Logger.getLogger(ScheduleDetailsPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private String getText() {
        return EntityManager.getText("schedule.txt");
    }    
    ...
    private void submit() {
        EntityManager.writeEntitys(nameDetails, "schedule.csv");
        EntityManager.textToFile(taMessage.getText(), "schedule.txt");
    }
}
